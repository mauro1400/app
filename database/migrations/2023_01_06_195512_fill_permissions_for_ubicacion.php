...
class FillPermissionsForUbicacion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUbicacion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ubicacion',
            'admin.ubicacion.index',
            'admin.ubicacion.create',
            'admin.ubicacion.show',
            'admin.ubicacion.edit',
            'admin.ubicacion.delete',
            'admin.ubicacion.bulk-delete',
        ]);
