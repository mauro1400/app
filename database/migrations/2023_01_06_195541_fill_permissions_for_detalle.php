...
class FillPermissionsForDetalle extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDetalle constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.detalle',
            'admin.detalle.index',
            'admin.detalle.create',
            'admin.detalle.show',
            'admin.detalle.edit',
            'admin.detalle.delete',
            'admin.detalle.bulk-delete',
        ]);
