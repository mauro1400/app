...
class FillPermissionsForPlantum extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPlantum constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.plantum',
            'admin.plantum.index',
            'admin.plantum.create',
            'admin.plantum.show',
            'admin.plantum.edit',
            'admin.plantum.delete',
            'admin.plantum.bulk-delete',
        ]);
