                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'COD_P'">{{ trans('admin.product.columns.COD_P') }}</th>
                                        <th is='sortable' :column="'NOMBRE_PRO'">{{ trans('admin.product.columns.NOMBRE_PRO') }}</th>
                                        <th is='sortable' :column="'UNDAD_MEDIDA'">{{ trans('admin.product.columns.UNDAD_MEDIDA') }}</th>
                                        <th is='sortable' :column="'FECHA_P'">{{ trans('admin.product.columns.FECHA_P') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.COD_P }}</td>
                                        ...
                                        <td>@{{ item.UNDAD_MEDIDA }}</td>
                                        <td>@{{ item.FECHA_P | date }}</td>
